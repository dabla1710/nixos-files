    ...
    $.getJSON(chrome.runtime.getURL(`_locales/${items.lang}/controls.json`), (langData) => {
      ...
      chrome.storage.local.get({
        ...
        var actualCode = ['window.replaceBuy = ' + items.quickbuybuttons + ';',
          ...
          `window.ExchangeSteamRates= ${JSON.stringify(items.steam_rates.rates || {})}`,
        ].join('\r\n');
...
var barRenderer = document.createElement('script');
...
var categoryAxisRenderer = document.createElement('script');
